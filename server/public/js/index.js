	    ...
	    _createClass(Base, [{
	        ...
	        */
	        ...
	        value: function changePlayNav(e) {
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTarger);
	            $cur.addClass('active').siblings().removeClass('active');
	            self.cur_play = $cur.attr('desc').toLocaleLowerCase();
	            (0, _jquery2.default)('#zx_sm span').html(self.play_list.get(slef.cur_play).tip);
	            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active');
	            self.getCount();
	        }
	    }, {
	        key: 'assisHandle',
	        value: function assisHandle(e) {
	            e.preventDefault();
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTarget);
	            var index = $cur.index();
	        ...
	        */
	        ...
	        value: function getRandomCode(e) {
	            e.preventDefault();
	            var num = e.currentTarger.getAttribute('count');
	...
	var Calculate = function () {
	    ...
	    _createClass(Calculate, [{
	        ...
	        value: function computeCount(active, play_name) {
	            var count = 0;
	            var exist = this.play_list.has(play_name); //判断下play_list里有没有这个玩法的标识(play_list是个map类型)
	            var arr = new Array(active).fill('0'); //选中多少个生成多少个元素的数组
